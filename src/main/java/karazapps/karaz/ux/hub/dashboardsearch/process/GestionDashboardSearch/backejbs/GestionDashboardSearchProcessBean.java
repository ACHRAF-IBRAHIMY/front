...
@Stateless(name="karaz/ux/hub/dashboardsearch/process/GestionDashboardSearchProcess",  mappedName="karaz/ux/hub/dashboardsearch/process/GestionDashboardSearchProcess")
@Remote
...
public class GestionDashboardSearchProcessBean extends XProcess implements Process {  
	...
	public String getProcessQN() { 
		return "karaz/ux/hub/dashboardsearch/process/GestionDashboardSearchProcess";
	}
