package karazapps.karaz.ux.hub.dashboardsearch.search.allKarazuxresults.backejbs; 
...
@Stateless(name="karaz/ux/hub/dashboardsearch/search/AllKarazuxresults", mappedName="karaz/ux/hub/dashboardsearch/search/AllKarazuxresults") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class AllKarazuxresultsBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(AllKarazuxresultsBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/dashboardsearch/search/AllKarazuxresults";
