package karazapps.karaz.ux.hub.dashboardsearch.search.publicCentralSearch.backejbs; 
...
@Stateless(name="karaz/ux/hub/dashboardsearch/search/PublicCentralSearch", mappedName="karaz/ux/hub/dashboardsearch/search/PublicCentralSearch") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class PublicCentralSearchBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(PublicCentralSearchBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/dashboardsearch/search/PublicCentralSearch";
	...
	public PublicCentralSearchBean () {
