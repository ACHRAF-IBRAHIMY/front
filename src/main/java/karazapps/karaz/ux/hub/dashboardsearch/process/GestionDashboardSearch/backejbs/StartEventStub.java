...
import ma.ribatis.karaz.activities.StartActivityStub;
...
/**  activityAsType = StartActivity **/
/**nn parentActivityAsStub = StartActivityStub **/
public abstract class StartEventStub extends StartActivityStub {
	protected boolean overriding=true; 
	public StartEventStub(ActivityInstance ai, DataObjectServiceLocal doService){ super(ai, doService); jx = JXFactory.getJXObject(di); }
