package karazapps.karaz.ux.hub.portailsearch.search.opinionTextMining.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/OpinionTextMining", mappedName="karaz/ux/hub/portailsearch/search/OpinionTextMining") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class OpinionTextMiningBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(OpinionTextMiningBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/OpinionTextMining";
