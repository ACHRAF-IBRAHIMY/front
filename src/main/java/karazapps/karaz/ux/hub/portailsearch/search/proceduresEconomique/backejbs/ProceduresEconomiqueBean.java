package karazapps.karaz.ux.hub.portailsearch.search.proceduresEconomique.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/ProceduresEconomique", mappedName="karaz/ux/hub/portailsearch/search/ProceduresEconomique") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class ProceduresEconomiqueBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(ProceduresEconomiqueBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/ProceduresEconomique";
	...
	public ProceduresEconomiqueBean () {
