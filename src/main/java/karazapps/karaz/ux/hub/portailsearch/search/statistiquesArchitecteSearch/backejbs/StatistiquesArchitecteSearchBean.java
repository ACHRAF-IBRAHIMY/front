package karazapps.karaz.ux.hub.portailsearch.search.statistiquesArchitecteSearch.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/StatistiquesArchitecteSearch", mappedName="karaz/ux/hub/portailsearch/search/StatistiquesArchitecteSearch") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class StatistiquesArchitecteSearchBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(StatistiquesArchitecteSearchBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/StatistiquesArchitecteSearch";
	...
	public StatistiquesArchitecteSearchBean () {
