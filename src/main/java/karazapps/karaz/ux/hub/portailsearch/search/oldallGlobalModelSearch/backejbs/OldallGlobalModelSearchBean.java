package karazapps.karaz.ux.hub.portailsearch.search.oldallGlobalModelSearch.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/OldallGlobalModelSearch", mappedName="karaz/ux/hub/portailsearch/search/OldallGlobalModelSearch") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class OldallGlobalModelSearchBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(OldallGlobalModelSearchBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/OldallGlobalModelSearch";
	...
	public OldallGlobalModelSearchBean () {
