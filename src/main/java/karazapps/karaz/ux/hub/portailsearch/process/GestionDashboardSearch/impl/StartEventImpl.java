package karazapps.karaz.ux.hub.portailsearch.process.GestionDashboardSearch.impl; 
...
import karazapps.karaz.ux.hub.portailsearch.process.GestionDashboardSearch.backejbs.StartEventStub ;

public class StartEventImpl extends StartEventStub { 
	public StartEventImpl(ActivityInstance ai, DataObjectServiceLocal doService) { super(ai, doService); } 
	   
		 
 
				
	@Override
	public  void execute(PortailSearch  jx) {
	}
