package karazapps.karaz.ux.hub.portailsearch.search.organisationSearch.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/OrganisationSearch", mappedName="karaz/ux/hub/portailsearch/search/OrganisationSearch") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class OrganisationSearchBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(OrganisationSearchBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/OrganisationSearch";
