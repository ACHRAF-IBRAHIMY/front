package karazapps.karaz.ux.hub.portailsearch.search.mapBrwChartSearch.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/MapBrwChartSearch", mappedName="karaz/ux/hub/portailsearch/search/MapBrwChartSearch") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class MapBrwChartSearchBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(MapBrwChartSearchBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/MapBrwChartSearch";
