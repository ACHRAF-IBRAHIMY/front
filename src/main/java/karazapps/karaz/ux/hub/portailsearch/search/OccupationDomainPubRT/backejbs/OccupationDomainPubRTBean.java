package karazapps.karaz.ux.hub.portailsearch.search.OccupationDomainPubRT.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/OccupationDomainPubRT", mappedName="karaz/ux/hub/portailsearch/search/OccupationDomainPubRT") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class OccupationDomainPubRTBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(OccupationDomainPubRTBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/OccupationDomainPubRT";
	...
	public OccupationDomainPubRTBean () {
