 ...
 */
@Stateless(name = "karaz/ux/hub/portailsearch/reporting/reportsimulateur/ReportsimulateurReport", mappedName = "karaz/ux/hub/portailsearch/reporting/reportsimulateur/ReportsimulateurReport")
@Remote
public class ReportsimulateurReport implements PrintAction {
	@EJB 
