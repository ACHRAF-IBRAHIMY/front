package karazapps.karaz.ux.hub.portailsearch.search.dbLeftSide.backejbs; 
...
@Stateless(name="karaz/ux/hub/portailsearch/search/DbLeftSide", mappedName="karaz/ux/hub/portailsearch/search/DbLeftSide") 
@TransactionManagement(TransactionManagementType.BEAN)
@Remote
public class DbLeftSideBean implements KarazQuery {

	private static final int DefaultMaxResults = 10;
	private static final int DefaultFirstResult = 0;
	private static Logger logger = Logger.getLogger(DbLeftSideBean.class); 
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	XPathExpression<Element> xpath_data_entity = XPathFactory.instance().compile("entity", Filters.element());

	private String searchPath = "karaz/ux/hub/portailsearch/search/DbLeftSide";
