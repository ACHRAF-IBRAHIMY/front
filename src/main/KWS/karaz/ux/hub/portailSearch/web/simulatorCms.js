...
$.ajax({
type: "post",
url: URL_SEARCH+"?operation=wselastic&shortUrl="+"/"+simulator_index_qr+"/qrs/_search",
...
type: "post",
//url: "http://localhost:9200/"+simulator_index_qr+"/qrs/"+id,
url: URL_SEARCH+"?operation=wselastic&shortUrl="+"/simulator_index_tree/tree/2",
datatype: "application/json",
...
type: "post",
//url: "http://localhost:9200/"+simulator_index_qr+"/qrs/"+id,
url: URL_SEARCH+"?operation=wselastic&shortUrl="+"/simulator_index_tree_hs/tree/"+date,
datatype: "application/json",
data:JSON.stringify(treeObject),
contentType: "application/json",
beforeSend: function (xhr) {
...
type: "get",
//url: "http://localhost:9200/"+simulator_index_qr+"/qrs/"+id,
url: URL_SEARCH+"?operation=wselastic&shortUrl="+"/simulator_index_matrix/columns/"+id,
datatype: "application/json",
contentType: "application/json",
beforeSend: function (xhr) {
    xhr.setRequestHeader("Authorization", AUTH);
...
type: "post",
//url: "http://localhost:9200/"+simulator_index_qr+"/qrs/"+id,
url: URL_SEARCH+"?operation=wselastic&shortUrl="+"/simulator_index_matrix/columns/" + str,
datatype: "application/json",
...
$.ajax({
type: "post",
url: URL_SEARCH+"?operation=wselastic&shortUrl="+"/"+index,
//url: "http://localhost:9200/index_classification_cluster/avis/_search",
datatype: "application/json",
contentType: "application/json",
beforeSend: function (xhr) {
...
$.ajax({
type: "post",
url: URL_SEARCH+"?operation=wselastic&shortUrl="+"/"+index+id,
//url: "http://localhost:9200/index_classification_cluster/avis/_search",
datatype: "application/json",
contentType: "application/json",
beforeSend: function (xhr) {
